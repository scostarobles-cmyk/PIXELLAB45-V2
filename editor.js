...
async function cargarEditor(){
    ...
    if(editor){
        ...
        monitorPIXELLAB(
            ...
            "ok",
            "Portada",
            "Cargando datos desde editor.json",
            "monitorEditor"
        );
        ...
        if(
            ...
            if(titulo && editor.portada.titulo.estilo){
    ...
    // SI NO EXISTE EDITOR.JSON

    monitorPIXELLAB(
        "Editorial",
        "proceso",
        "Portada",
        "Creando editor.json inicial",
        "monitorEditor"
    );
